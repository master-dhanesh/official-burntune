            ...
            {isUser ? (
              <>
                <div className="dropdown ">
                  <button
                    className="p-0 btn bg-transparent dropdown-toggle"
                    type="button"
                  ...
                  >
                    <li>
                      <span className="dropdown-item" onClick={UserLogout}>
                        Logout
                      </span>
                    </li>
                  </ul>
              ...
              <>
                ...
                >
                  <img
                    src={loginlogo}
                    className={css.b_loginimg}
                    alt={loginlogo}
                  />
                  &nbsp; Login
                </button>
                {/* <button onClick={props.callRef} className={css.b_transbutton}>Join Us</button> */}
                <a className="text-light" href="#emailInp">
                  <button onClick={props.callRef} className={css.b_transbutton}>
                    Join Us
                  </button>
                </a>
              </>
