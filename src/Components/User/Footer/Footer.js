...
function Footer(props) {
  ...
  const SendEmail = (e) => {
    ...
    const emailLength = emailInp.current.value;
  ...
  return (
    <div id="scroll_footer" className={css.b_footer_container}>
      <section className={`${css.b_footer_section1}`}>
        <Link
          to="/business/work-together"
          className={`${css.b_footer_section1_A} text-light p-5`}
        >
          <div>
          ...
          <div>
            <div className={css.b_footer_button}>
              <img src={arrowButton} alt={arrowButton} />
            </div>
          </div>
        </Link>
        <Link
          to="/business/join-team"
          className={`${css.b_footer_section1_B} text-light p-5`}
        >
          <div>
          ...
          <div>
            ...
            <form onSubmit={SendEmail} className={css.b_footer_input_container}>
              ...
              <input
                ...
                hidden
                name="message"
                value="Thankyou so much for the subscription, We'll keep you updated."
                type="text"
              />
              ...
              <input
                ...
                type="text"
              />
              <button className={css.b_footer_button}>
                <img src={arrowButton} alt={arrowButton} />
              </button>
            </form>
          </div>
          <p className={css.b_footer_copyright}>
            ©2021 Burntune Music and Media Pvt Ltd.All Rights reserved & nbsp;
            <Link className="text-light text-decoration-none" to="/tnc">
              Terms & Conditions
            </Link>
          </p>
        </div>
        <div className={`${css.b_footer_section2_B} p-5`}>
          ...
          <h1 className={css.b_footer_links}>
            <a
              ...
              target="_blank"
              title="Facebook"
              href="https://www.facebook.com/burntunemusic"
            >
              <img className={css.b_footer_link_logo} src={fb} alt={fb} />
            </a>
            <a
              rel="noreferrer"
              target="_blank"
              title="Instagram"
              href="https://www.instagram.com/burntune/"
            >
              <img className={css.b_footer_link_logo} src={ins} alt={ins} />
            </a>
            <a
              rel="noreferrer"
              target="_blank"
              title="LinkedIn"
              href="https://www.linkedin.com/company/burntune"
            >
              <img className={css.b_footer_link_logo} src={ln} alt={ln} />
            </a>
            <a
              rel="noreferrer"
              target="_blank"
              title="Youtube"
              href="https://www.youtube.com/channel/UCxPzr_ZIe9_7LNEw3ZWChbw?reload=9"
            >
              <img className={css.b_footer_link_logo} src={yt} alt={yt} />
            </a>
            <a
              rel="noreferrer"
              target="_blank"
              title="Twitter"
              href="https://twitter.com/burntunemusic"
            >
              <img className={css.b_footer_link_logo} src={tw} alt={tw} />
            </a>
            <a
              rel="noreferrer"
              target="_blank"
              title="Spotify"
              href="https://open.spotify.com/show/0vo6IyS9S56Evi5WEUIM8K"
            >
              <img
                className={css.b_footer_link_logo}
                src={Spotify}
                alt={Spotify}
              />
            </a>
            <a
              ...
              target="_blank"
              title="Clubhouse"
              href="https://clubhouse.com/club/burntune-music-spectrum"
            >
              <img
                className={css.b_footer_link_logo}
                style={{ height: "24px" }}
          ...
          <p className={css.b_footer_dev}>
            ...
            <a
              rel="noreferrer"
              target="_blank"
              href="https://www.instagram.com/master.dhanesh/"
            >
              @master.dhanesh
            </a>
